            ...
            children: [
              ...
              PopupMenuButton<String>(
                ...
                itemBuilder: (BuildContext context) => [
                  ...
                  PopupMenuItem(value: 'settings', child: Row(
                    children: [
                      Icon(Icons.settings),
                      SizedBox(width: 10),
                      Text('Settings', style: TextStyle(color: Theme.of(context).textTheme.bodyMedium?.color),),
                    ],
                  )),
                  ...
                  PopupMenuItem(value: 'privacy', child: Row(
                    children: [
                      Icon(Icons.privacy_tip_outlined),
                      SizedBox(width: 10),
                      Text('Privacy policy', style: TextStyle(color: Theme.of(context).textTheme.bodyMedium?.color),)
                    ],
                  )),
                  ...
                  PopupMenuItem(value: 'refresh', child: Row(
                    children: [
                      Icon(Icons.refresh),
                      SizedBox(width: 10),
                      Text('Refresh', style: TextStyle(color: Theme.of(context).textTheme.bodyMedium?.color),)
                    ],
                  )),
